...
function guessNumber(randomNum) {
  let guess = parseInt(window.prompt("Please guess the number between 1-100"));
  console.log(guess);
  ...
  if (guess === randomNum) {
    returnMessage = `You win! :) The number was: ${randomNum}, You guess the number in ${attempt} attempt`;
  } else if (attempt === 10) {
